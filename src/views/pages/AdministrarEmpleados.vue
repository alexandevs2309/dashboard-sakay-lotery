      ...
      <TabView>
          ...
          <TabPanel header="Datos">
              ...
              <div class="grid grid-cols-2 gap-4 bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div>
                      <label class="block text-gray-600">Clave</label>
                  ...
                  <div>
                      <label class="block text-gray-600">Máximo de ventas antes de bloqueo de ventas</label>
                      <InputText v-model="employee.maxSales" placeholder="10000" class="w-full" />
                  </div>
                  <div>
                      <label class="block text-gray-600">Código dispositivo</label>
          ...
          <TabPanel header="Com. Lot">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-xl font-semibold text-gray-700 mb-4">Comisiones de Loterías</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-for="game in lotteryCommissions" :key="game.name" class="flex items-center space-x-4">
                            ...
                            <span class="w-1/4 text-gray-600">{{ game.name }}</span>
