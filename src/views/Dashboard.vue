    ...
    <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="card mb-0">
                <div class="flex justify-between mb-4">
                    <div>
                        <span class="block text-muted-color font-medium mb-4">Loterias</span>
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="card mb-0">
                <div class="flex justify-between mb-4">
                    <div>
                        <span class="block text-muted-color font-medium mb-4">Premios de hoy</span>
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="card p-0">
                <div class="card bg-green-500 w-full mx-0 p-8">
                    <div class="font-semibold text-xl mb-4 text-white">Resultados</div>
                </div>
